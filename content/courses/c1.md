...
aliases:
    ...
    - /tags/matching-model/
tags: ["Beveridge curve","business cycles","inefficiency","government spending","job rationing","matching function","fiscal multiplier","unemployment","vacancies","unemployment gap","unemployment insurance","wage rigidity","public employment","frictional unemployment","state dependence","welfare analysis","labor-market tightness"]
