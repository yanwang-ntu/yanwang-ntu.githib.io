...
+ [Michaillat (2012)](/1/) – This paper establishes that usual matching models of the labor market do not have job rationing. It then develops a matching model with job rationing. This model is a precursor for the model of slack studied in this course.
...
+ [Barro, Grossman (1971)](https://www.jstor.org/stable/1910543) – This paper develops a disequilibrium model of slack with labor and product markets. This model is a precursor for the model of slack with labor and product markets studied in this course.
...
+ [Petrosky-Nadeau, Wasmer (2015)](https://doi.org/10.1016/j.jmoneco.2015.01.006) – This paper develops a model of slack with product, labor, and financial markets—each organized around a matching function. 
...
+ [Michaillat, Saez (2022)](/13/) – This paper derives the formula $u^\ast = \sqrt{uv}$. The formula is based on the assumptions that servicing a vacancy requires one worker; home production by jobseekers is nonexistent; and the Beveridge curve is an hyperbola (so the unemployment rate is inversely related to the vacancy rate). The paper then applies the formula to the United States, 1930–2022.
...
+ [Stock, Watson (2001)](https://doi.org/10.1257/jep.15.4.101) – This paper revisits the effect of monetary policy on unemployment using VARs.
...
+ [Samuelson (1955)](https://doi.org/10.2307/1925849) – This paper proposes a diagrammatic derivation of the Samuelson (1954) rule.
