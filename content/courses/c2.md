...
+ [Cooley, Prescott (1995)](https://doi.org/10.2307/j.ctv14163jx.7) – This paper reviews facts about business cycles and attempt to explain them using a neoclassical growth model.
...
+ [Michaillat (2012)](/1/) – This paper establishes that usual matching models of the labor market do not have job rationing and develops a matching model with job rationing. This model is a precursor for the model of slack studied in this course.
...
+ [Jones (2015)](https://doi.org/10.1257/jep.29.1.29) – This paper reviews key facts about income and wealth inequality. It then explains how the facts relate to macroeconomics theory via the Pareto distribution.
...
+ [Barro, Grossman (1971)](https://www.jstor.org/stable/1910543) – This paper develops a disequilibrium model of slack with labor and product markets. This model is a precursor of the matching model of slack in Michaillat, Saez (2015).
