...
aliases: 
    ...
    - /w125.html
    - /w114.html
tags: ["Beveridge curve","business cycles","economic slack","efficiency","government spending","matching function","monetary policy","price rigidity","stabilization policy","sufficient statistics","unemployment gap"]
...
+ [Hall (2005)](https://doi.org/10.1257/0002828053828482) – This paper shows how a fixed wage norm can be inserted into a matching model, and explains why such a model generates large fluctuations in unemployment and vacancies.
+ [Nakamura, Steinsson (2013)](https://doi.org/10.1146/annurev-economics-061109-080430) – This paper reviews evidence on price rigidity and discusses how this evidence is used to build macroeconomic models.
+ [Dickens et al (2007)](https://doi.org/10.1257/jep.21.2.195) – This paper reviews  evidence on wage rigidity collected by a large international project.

##### Additional readings

+ [Shimer (2005)](https://doi.org/10.1257/0002828053828572) – This paper shows in a matching model with Nash bargaining, wages are too flexible to generate realistic fluctuations in unemployment and vacancies.
...
+ [Haefke, Sonntag, van Rens (2013)](https://doi.org/10.1016/j.jmoneco.2013.09.003) – This paper constructs a time series for wages of newly hired workers and find that the elasticity of these wages with respect to productivity is 0.7–0.8.
...
+ [Michaillat (2012)](/1/) – This paper establishes that usual matching models of the labor market do not have job rationing. It then develops a matching model with job rationing. In the model of slack with labor and product markets studied here, the labor market is modeled as in this paper.
+ [Barro, Grossman (1971)](https://www.jstor.org/stable/1910543) – This paper develops a disequilibrium model with labor and product markets. This model is a precursor to the model of slack with labor and product markets.

##### Additional readings

+ [Blanchard, Kiyotaki (1987)](https://www.jstor.org/stable/1814537) – This paper develops a monopolistic model of business cycles. The model has the same architecture as the Barro-Grossman model, but a different market structure. The model is a direct precursor to the New Keynesian model.
...
+ [Basu, Fernald, Kimball (2006)](https://doi.org/10.1257/aer.96.5.1418) – This paper shows that in the United States, employment falls when technology improves. This empirical finding is consistent with the prediction of the dynamic model of slack.
+ [Blanchard, Gali (2007)](https://doi.org/10.1111/j.1538-4616.2007.00015.x) – This paper introduces the concept of divine coincidence and examines under which assumptions it might and might not hold.
...
+ [Michaillat, Saez (2022)](/13/) – This paper derives the formula $u^\ast = \sqrt{uv}$ for the efficient unemployment rate. The formula is based on the assumptions that servicing a vacancy requires one worker; home production by jobseekers is nonexistent; and the Beveridge curve is an hyperbola. The paper then applies the formula to the United States, 1930–2022.
...
+ [Michaillat (2014)](/2/) – This paper establishes that in the model of slack, the public-employment multiplier is positive but less than one, and the multiplier is larger when the unemployment rate is higher.
