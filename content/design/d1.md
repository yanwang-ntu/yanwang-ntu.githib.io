...
- [LaTeX Beamer template to produce academic presentations](https://github.com/pmichaillat/latex-presentation)
- [Presentation obtained from template](/d1.pdf)
...
There are some sans-serif Greek alphabets, but the letters look unusual and are hard to recognize. So for the Greek letters in math, the template uses the [Euler font](http://luc.devroye.org/fonts-26139.html). These Greek letters look good, have the same thickness as the text letters, and are distinctive.
