...
- `\al{text}` is the standard alert: it colors the text in magenta.
- `\gal{text}` colors the text in green (for instance to indicate a positive number).
- `\ral{text}` colors the text in red (for instance to indicate a negative number).
- `\bal{text}` colors the text in blue (for instance to indicate a zero).
