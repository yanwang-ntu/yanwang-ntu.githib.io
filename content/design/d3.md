---
title: "LaTeX Commands to Typeset and Read Math" 
date: 2023-01-01
url: /d3/
# tags: ["differential equations","optimal control"]
author: "Pascal Michaillat"
description: "This style file collects LaTeX commands that make math easy to typeset and easy to read." 
summary: "This style file collects LaTeX commands that make math easy to typeset and easy to read." 
cover:
    image: "/d3.png"
    alt: "Mathematical expression produced with template"
    relative: false
editPost:
    URL: "https://github.com/pascalmichaillat/latex-math"
...
- [math.sty](/math.sty) -- This LaTeX style file collecting many mathematical commands. Must be included in the same folder as your LaTeX project.
