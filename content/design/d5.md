...
The current version of the template is built with Hugo v0.124.1. The update to Hugo v0.120 and then Hugo v0.123 introduced some issues with the previous version of the template, but these issues are now resolved.[^1] 
...
+ `cv.pdf` – Curriculum vitae linked to the CV icon on the homepage. This CV template was created by [Matthew Butterick](https://practicaltypography.com/resumes.html).
