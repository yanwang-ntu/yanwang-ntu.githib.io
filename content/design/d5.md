...
summary: "This template produces a minimalist academic website with Hugo. The website theme is based on Papermod, and the website is hosted on GitHub Pages." 
cover:
    image: "/d5.png"
...
The website is built with Hugo. The website theme is based on Papermod, and the website is hosted on GitHub Pages. The website design is as minimalist as possible so the website is easy to navigate, fast to load, easy to maintain, and especially so the focus is on the research and teaching material.
