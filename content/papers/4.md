...
summary: "This paper develops a theory of optimal unemployment insurance in matching models, with implications for the cyclicality of optimal unemployment insurance." 
cover:
    image: "/4.png"
...
#### Figures 4:  The effect of UI on labor market tightness differs across matching models. It can be measured by the wedge between the macroelasticity ($\epsilon^M$) and microelasticity ($\epsilon^m$) of unemployment with respect to UI.
