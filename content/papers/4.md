...
+ [Companion paper](/5/) – This companion paper applies the theory from the paper to determine how the generosity of unemployment insurance should vary over the business cycle. It finds that in the United States, optimal unemployment insurance is countercyclical (more generous in bad times).
