...
+ [Previous version of the paper (2014)](https://doi.org/10.3386/w19777) – In the previous version of the model the government issues not only bonds but also money. The model provides a microfoundation for the IS-LM model. It can be used to analyze open-market operations and helicopter drops of money.
