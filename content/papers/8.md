...
- [Code & data](https://github.com/pmichaillat/pricing-with-fairness)
...
#### Figure 1:  Impulse responses to an expansionary monetary shock in the standard New Keynesian model and New Keynesian model with fairness concerns
